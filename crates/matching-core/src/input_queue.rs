...
pub struct PerSymbolInputQueue {
    capacity: usize,
    entries: VecDeque<InputJournalEntry>,
}

impl PerSymbolInputQueue {
...
mod tests {
    ...
    #[test]
    fn queue_drains_entries_in_fifo_order() {
    ...
    #[test]
    fn queue_exposes_capacity_and_watermark_state() {
    ...
    #[test]
    fn queue_returns_error_when_capacity_is_full() {
        let mut queue = PerSymbolInputQueue::new(2);
